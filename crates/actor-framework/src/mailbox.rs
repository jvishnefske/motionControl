...
pub type MailboxSender<'a, M, const N: usize> = embassy_sync::channel::Sender<'a, Mutex, M, N>;

/// Receiver half — owned by exactly one actor task.
pub type MailboxReceiver<'a, M, const N: usize> = embassy_sync::channel::Receiver<'a, Mutex, M, N>;
